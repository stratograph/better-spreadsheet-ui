...
- The **initiative panel** (Row dropdown) shows a small progress bar and "X / Y fields completed" count for the selected row, based on how many of that row's fields are non-empty in the Value tab. It updates live after each successful save, no reload needed.
